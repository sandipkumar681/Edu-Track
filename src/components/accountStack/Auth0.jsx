...
const Auth0 = () => {
  ...
  const importArrayFromServer = async () => {
    Alert.alert(
      "Notice",
      "Do you really want to get your data from server ? It will take a few minutes to upload. \n\nPress OK to proceed.",
      [
        {
          text: "Cancel",
          style: "default",
  ...
  useEffect(() => {
    GoogleSignin.configure({
      webClientId:
        "240861090718-qkbgucjr4cn84unqf3aoud5jfcaa4s20.apps.googleusercontent.com",
      offlineAccess: false,
    });
